...
//NOTE:THIS FILE NEEDS TO BE MODIFIED FOR REGISTERING A DEVICE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
<!-- the home and how_to page have been converted to php files for the 
  ...
  <nav class="zone green">
      ...
      <li><a href="How_to.php">How it works</a></li> -->
  ...
  <div class="container zone red">
    ...
    <p>Please enter the information to register your device below.</p>
  </div>
  <div class="form-container">
   <!-- NOTE: FORM NEEDS TO BE MODIFIED!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! -->
    <form name="login-form" action="insert_coordinates_config.php" method="post"> 
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="api-key" name="api-key" placeholder="Thingspeak api key..."
         required>
      </div>
    </div>
    ...
    <div class="container zone red">
      ...
      <h2>Already have a device registered?</h2>
        <p>Then <a href="tracking_login.php"><u>CLICK HERE</u></a> to Access it's location!</p>
